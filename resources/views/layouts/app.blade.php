...
<body>
    <div class="wrapper">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="javascript:void(0)" style='width: 10%;margin-left: 15px;top:0px;'><img src="{{asset('logo/logo-white.png')}}" alt="img" class="fh5co_logo_width"/></a>
